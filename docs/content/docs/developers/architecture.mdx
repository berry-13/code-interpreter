...
| **package_init** | `docker/Dockerfile.package-init` | — | Build-time | Installs language runtimes onto a shared volume. |
| **Launcher** | `launcher/` (Rust) | — | Untrusted-adjacent | Boots the libkrun microVM and execs into the guest. |
