...
fn is_allowed_guest_env_key(key: &str, egress_gateway_enabled: bool) -> bool {
    const ALLOW_EXACT: &[&str] = &[
        ...
        // Sandbox network egress. The flag and its budgets are read by the
        ...
        "SANDBOX_NET_ALLOWED_HOSTS",
        "SANDBOX_NET_ALLOWED_PORTS",
        "SANDBOX_NET_IDLE_TIMEOUT_MS",
        "SANDBOX_NET_MAX_BYTES",
        "SANDBOX_NET_MAX_CONNECTIONS",
        "SANDBOX_NET_MAX_REQUESTS",
