...
/* The token bucket now lives in token-bucket.ts so net-egress-proxy.ts can
 * share it without importing this file's CLI entrypoint. Re-exported here to
 * keep this module's public surface unchanged. */
export { createTokenBucket, type TokenBucket };
